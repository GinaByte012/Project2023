...
function Feedback() {
  ...
  function downloadImage(imageName) {
    window.open(`http://ceprj.gachon.ac.kr:60001/download/${imageName}`);
  }
        ...
        <div>
          {params.value && (
            <>
              ...
              <button onClick={() => downloadImage(params.row.img_bf)}>다운로드</button>
            </>
          )}
        </div>
      )
        ...
        <div>
          {params.value && (
            <>
              ...
              <button onClick={() => downloadImage(params.row.classified)}>다운로드</button>
            </>
          )}
        </div>
      )
